          ...
          <div class="row">
              <div class="col-md-12">
                <div class="card ">
                    ...
                    <h4 class="card-title">Rank Table</h4>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                          ...
                          <?php
                          $i = 1;
                          $sql = mq("select * from users WHERE score <> 0 order by score desc");
                          while($data = $sql->fetch_array()) { ?>
                              <tr>
                                  ...
                                  <td>
                                    <a href="../user.php?uid=<?php echo $data["egv"]; ?>" target="_blank"><?php echo $data["name"]; ?></a> 
                                  </td>
                                  <td>
                                      <?php echo $data["score"]; ?>
                                  </td>
                                  <td>
                                      <?php echo email_preg($data["id"]); ?>
                                  </td>
                              </tr>
                              <?php $i += 1; ?>
                          <?php } ?>
