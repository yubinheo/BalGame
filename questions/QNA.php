                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table tablesorter " id="">
                                ...
                                <?php
                                $i = 1;
                                $sql = mq("select * from qna order by idx asc");
                                while($data = $sql->fetch_array()) { ?>
                                    <tr>
                                        <td>
                                            <a href="../view/view.php?idx=<?php echo $data["idx"]; ?>" rel="noopener noreferrer"><?php echo $data["title"]; ?></a> 
                                        </td>
                                        <td>
                                            <a href="../view/view.php?idx=<?php echo $data["idx"]; ?>" rel="noopener noreferrer"><?php echo $data["kag"]; ?></a> 
                                        </td>
                                        <td>
                                            <a href="../view/view.php?idx=<?php echo $data["idx"]; ?>" rel="noopener noreferrer"><?php echo $data["writer"]; ?></a> 
                                        </td>
                                        <td>
                                            <a href="../view/view.php?idx=<?php echo $data["idx"]; ?>" rel="noopener noreferrer"> <?php echo $data["created"]; ?></a> 
                                        </td>
                                    </tr>
                                    <?php $i += 1; ?>
                                <?php } ?>
