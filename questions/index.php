    ...
    <div class="main-panel">
      ...
      ?>
        <div class="alert alert-dark">
          ...
          <span style="font-size: 20px;">당신의 계정 번호는 <strong><span style="color: lightcoral"><?php echo $data["egv"]; ?></span></strong> 입니다.</span>
        </div>
      <?php } else { ?>
        <div class="alert alert-dark">
          <button type="button" aria-hidden="true" class="close" data-dismiss="alert" aria-label="Close">
          ...
          <span style="font-size: 20px;">로그인이 필요합니다.</span>
        </div>
      <?php } ?>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php
                  $sql = mq("select * from notice order by idx asc");
                ...
                ?>
                  <div class="alert alert-<?php echo $data["color"]; ?>">
                    ...
                    <span style="font-size: 20px;"><?php echo $data["contents"]; ?></span>
                    <hr />
                    <h4><?php echo $data["created"]; ?> (<?php echo $data["writer"]; ?>)</h4>
                  </div>
